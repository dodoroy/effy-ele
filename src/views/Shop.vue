          ...
          <section class="menu_container">
            ...
            <section class="buy_cart_container">
                ...
                <section class="gotopay" :class="{gotopay_acitvity: minimumOrderAmount <= 0}">
                    ...
                    <router-link :to="{path:'/checkout', query:{geohash, shopId}}" class="gotopay_button_style" v-else >去结算</router-link>
                </section>
            </section>
...
export default {
  ...
  methods: {
    ...
    async loaderMoreRating() {
      ...
      const ratingDate = await getRatingList(this.shopId, this.ratingOffset, this.ratingTagName)
